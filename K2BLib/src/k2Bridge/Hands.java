...
public class Hands implements org.apache.thrift.TBase<Hands, Hands._Fields>, java.io.Serializable, Cloneable, Comparable<Hands> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Hands");
  ...
  static {
    schemes.put(StandardScheme.class, new HandsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new HandsTupleSchemeFactory());
  }

  public Hand left; // required
  public Hand right; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.LEFT, new org.apache.thrift.meta_data.FieldMetaData("left", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Hand.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Hands.class, metaDataMap);
  }
  ...
  public Hands(Hands other) {
    if (other.isSetLeft()) {
      this.left = new Hand(other.left);
    }
    if (other.isSetRight()) {
      this.right = new Hand(other.right);
    }
  }

  public Hands deepCopy() {
    return new Hands(this);
  }
  ...
  public Hands setLeft(Hand left) {
    this.left = left;
    return this;
  }
  ...
  public Hands setRight(Hand right) {
    this.right = right;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Hands)
      return this.equals((Hands)that);
    return false;
  }

  public boolean equals(Hands that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(Hands other) {
  ...
  private static class HandsStandardSchemeFactory implements SchemeFactory {
    public HandsStandardScheme getScheme() {
      return new HandsStandardScheme();
    }
  }

  private static class HandsStandardScheme extends StandardScheme<Hands> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Hands struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Hands struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class HandsTupleSchemeFactory implements SchemeFactory {
    public HandsTupleScheme getScheme() {
      return new HandsTupleScheme();
    }
  }

  private static class HandsTupleScheme extends TupleScheme<Hands> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Hands struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Hands struct) throws org.apache.thrift.TException {
